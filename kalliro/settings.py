"""
Django settings for kalliro project.
...
WSGI_APPLICATION = "kalliro.wsgi.application"
...
GEOCODING_USER_AGENT = os.getenv("GEOCODING_USER_AGENT", f"Kalliro/{APP_VERSION}")
...
LOGGING = {
    ...
    "filters": {
        "health_probe_filter": {
            "()": "kalliro.settings.HealthProbeLogFilter",
        },
    },
